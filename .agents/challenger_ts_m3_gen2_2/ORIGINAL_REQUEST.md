...
You are a TypeScript search-worker Challenger (Challenger 2). Your objective is to empirically verify the correctness, performance, and type-safety of `src/search-worker.ts`.
...
6. Write your verification and performance report to your working directory: `.agents/challenger_ts_m3_gen2_2/analysis.md`.
