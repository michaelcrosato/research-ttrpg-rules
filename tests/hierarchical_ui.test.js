...
describe('Systems Indexer - Hierarchical Sub-vector Explanations UI Tests', () => {
  ...
  test('Should search parent namespace and display combined sub-vector explanations', async () => {
    ...
    const gameAItem = Array.from(gameItems).find(item => item.querySelector('.vector-game-title').textContent === 'Game A');
    const gameBItem = Array.from(gameItems).find(item => item.querySelector('.vector-game-title').textContent === 'Game B');
    const gameCItem = Array.from(gameItems).find(item => item.querySelector('.vector-game-title').textContent === 'Game C');
