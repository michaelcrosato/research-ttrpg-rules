...
(function _f(self) {
  ...
  w.assign = function (a) {
    ...
    if (b || b === '') {
      if (typeof b === 'object' && b.constructor !== RegExp) {
        ...
        try {
          ...
          console.error(
            ...
            b,
            'is not supported on this platform. It falls back to using simple whitespace splitter instead: /s+/.'
          ),
            (this.split = /\s+/);
        }
      } else {
      ...
      try {
        ...
        console.warn(
          'This platform does not support unicode regex. It falls back to using simple whitespace splitter instead: /s+/.'
        ),
          (this.split = /\s+/);
      }
  ...
  w.encode = function (a, c) {
    ...
    this.normalize &&
      (typeof this.normalize === 'function'
        ? (a = this.normalize(a))
        : (a = ja ? a.normalize('NFKD').replace(ja, '').toLowerCase() : a.toLowerCase()));
    ...
    let e = [],
      ...
      f,
      g,
      k = this.split || this.split === '' ? a.split(this.split) : [a];
          ...
          if (!this.filter || (typeof this.filter === 'function' ? this.filter(m) : !this.filter.has(m))) {
            ...
            if (m && (this.mapper || (this.dedupe && m.length > 1))) {
              ...
              for (let u = 0, r = '', t, n; u < m.length; u++) {
                (t = m.charAt(u)),
                  (t === r && this.dedupe) ||
                    ((n = this.mapper && this.mapper.get(t)) || n === ''
                      ? (n === r && this.dedupe) || !(r = n) || (h += n)
                      : (h += r = t));
              }
              m = h;
            }
            this.matcher &&
              m.length > 1 &&
              (this.J || (this.J = new RegExp('(' + this.h + ')', 'g')),
            ...
            this.cache &&
              p.length <= this.I &&
              (this.D.set(p, m), this.D.size > this.L && (this.D.clear(), (this.I = (this.I / 1.1) | 0)));
            if (m) {
              if (m !== p) {
                if (c) {
                  if (d[m]) {
    ...
    this.cache &&
      a.length <= this.H &&
      (this.B.set(a, e), this.B.size > this.L && (this.B.clear(), (this.H = (this.H / 1.1) | 0)));
    return e;
  };
  function la(a) {
    a.F = null;
  ...
  const ta = new Map([
    ...
    ua = [/([^aeo])h(.)/g, '$1$2', /([aeo])h([^aeo]|$)/g, '$1$2', /(.)\1+/g, '$1'];
  const va = {
    a: '',
    e: '',
    i: '',
  ...
  var wa = {
    ...
    Default: ra,
    Normalize: ra,
    LatinBalance: { mapper: sa },
    LatinAdvanced: { mapper: sa, matcher: ta, replacer: ua },
    LatinExtra: { mapper: sa, replacer: ua.concat([/(?!^)[aeo]/g, '']), matcher: ta },
    LatinSoundex: {
      dedupe: !1,
      include: { letter: !0 },
      finalize: function (a) {
        for (let b = 0; b < a.length; b++) {
          ...
          for (
            ...
            f < c.length &&
            ((g = c.charAt(f)),
            g === 'h' || g === 'w' || !(g = va[g]) || g === d || ((e += g), (d = g), e.length !== 4));
            f++
          ) {}
          a[b] = e;
        }
  ...
  async function Ea(a) {
    ...
    switch (c) {
      case 'init':
        S = a.options || {};
        (c = a.factory)
          ? (Function('return ' + c)()(self), (Da = new self.FlexSearch.Index(S)), delete self.FlexSearch)
          : (Da = new T(S));
        postMessage({ id: b });
        break;
      default:
        ...
        if (c === 'export') {
          if (!S.export || typeof S.export !== 'function') {
            throw Error(
              'Either no extern configuration provided for the Worker-Index or no method was defined on the config property "export".'
            );
          }
        ...
        if (c === 'import') {
          if (!S.import || typeof S.import !== 'function') {
            throw Error(
              'Either no extern configuration provided for the Worker-Index or no method was defined on the config property "import".'
            );
          }
          e[0] && ((a = await S.import.call(Da, e[0])), Da.import(e[0], a));
        } else {
          (d = e && Da[c].apply(Da, e)) && d.then && (d = await d),
  ...
  function La(a = {}, c) {
    function b(k) {
      ...
      console.warn(
        'Worker is not available on this platform. Please report on Github: https://github.com/nextapps-de/flexsearch/issues'
      );
    }
  ...
  function Ma(a, c, b) {
    return c
      ? typeof module !== 'undefined'
        ...
        : import('worker_threads').then(function (worker) {
            return new worker['Worker']((1, eval)('import.meta.dirname') + '/node/node.mjs');
          })
      : a
        ? new window.Worker(URL.createObjectURL(new Blob(['onmessage=' + Ea.toString()], { type: 'text/javascript' })))
        : new window.Worker(
            typeof b === 'string'
              ? b
              : (0, eval)('import.meta.url')
                  ...
                  .replace('flexsearch.bundle.module.min.mjs', 'module/worker/worker.js'),
            { type: 'module' }
          );
  }
        ...
        for (e = 0; e < this.A.length; e++) {
          ...
          if (d && f) {
            ...
            for (let h = 0, l, m; h < f.length; h++) {
              if (
                ((l = f[h]), !k[l] && ((k[l] = 1), (g = d.get(l)) ? (m = g) : d.set(l, (m = [])), !b || !m.includes(a)))
              ) {
                if (m.length === 2 ** 31 - 1) {
                  g = new Aa(m);
                  if (this.fastupdate) {
  ...
  function Ua(a, c, b, e) {
        ...
        if (d.constructor === X) {
          ...
          if (q || d.tag) {
            ...
            if (r && (u || a.await)) {
              ...
              (d.resolve = !1),
                (d.index = null),
                (r = t ? n.searchAsync(d) : n.search(d)),
                (d.resolve = l),
                (d.index = n);
            }
          } else if (d.and) {
    ...
    u &&
      !a.await &&
      (a.await = new Promise(function (t) {
        a.return = t;
      }));
    if (u) {
  ...
  function Xa(a, c, b, e, d, f, g) {
    a.length &&
      ...
      a.length < 2 ? (this.result = a[0]) : ((this.result = Ya(a, c, b, !1, this.h)), (b = 0)));
    d && (this.await = null);
  ...
  function cb(a, c, b, e, d) {
    ...
    let h = d && d.boundary,
      l = !d || d.clip !== !1,
      m = d && d.merge && k && g && new RegExp(k + ' ' + g, 'g');
    d = d && d.ellipsis;
    var p = 0;
    if (typeof d === 'object') {
      var u = d.template;
    ...
    let r, t;
    typeof h === 'object' &&
      ((r = h.before), r === 0 && (r = -1), (t = h.after), t === 0 && (t = -1), (h = h.total || 9e5));
    p = new Map();
    for (let Pa = 0, ea, gb, pa; Pa < c.length; Pa++) {
      ...
      for (let ya = 0; ya < qa.length; ya++) {
        ...
        for (var E = 0; E < x.length; E++) {
          ...
          if (z && B) {
            var C = B.length,
              J = (ea.split ? B.replace(ea.split, '') : B).length - z.length,
              G = '',
              L = 0;
            ...
            G &&
              (h &&
                (A < 0 && (A = q.length + (q ? 1 : 0)),
                (D = q.length + (q ? 1 : 0) + G.length),
                (F += C),
                za.push(v.length),
                v.push({ match: G })),
              (q += (q ? ' ' : '') + G));
        ...
        if (r || t || (h && q.length - F > h)) {
          if (((F = h + F - u * 2), (E = D - A), r > 0 && (E += r), t > 0 && (E += t), E <= F)) {
            (x = r ? A - (r > 0 ? r : 0) : A - (((F - E) / 2) | 0)),
              (v = t ? D + (t > 0 ? t : 0) : x + F),
              l ||
                (x > 0 && q.charAt(x) !== ' ' && q.charAt(x - 1) !== ' ' && ((x = q.indexOf(' ', x)), x < 0 && (x = 0)),
                v < q.length &&
                  q.charAt(v - 1) !== ' ' &&
                  q.charAt(v) !== ' ' &&
                  ((v = q.lastIndexOf(' ', v)), v < D ? (v = D) : ++v)),
              (q = (x ? d : '') + q.substring(x, v) + (v < q.length ? d : ''));
          } else {
            D = [];
            A = {};
            F = {};
                ...
                if (G) {
                  if (J !== G) {
                    ...
                    if (C + q.length + 1 <= h) {
                      ...
                      (U = q.length + 1 - (h - C)),
                        U >= 0 && U < q.length && ((q = q.substring(U) + ' '), (D[y] = q + D[y])),
                        (E[y] = 1);
                    } else {
                      E[y] = 1;
                      continue;
  ...
  w.resolve = function (a, c, b, e, d) {
    ...
    f.length &&
      (typeof a === 'object'
        ? ((e = a.highlight || this.highlight), (b = !!e || a.enrich), (c = a.offset), (a = a.limit))
        : ((e = e || this.highlight), (b = !!e || b)),
      (f = d ? (b ? Ta.call(this.index, f) : f) : Sa.call(this.index, f, a || 100, c, b)));
  ...
  w.finalize = function (a, c) {
    ...
    c &&
      !this.query &&
      console.warn(
        'There was no query specified for highlighting. Please specify a query within the highlight resolver stage like { query: "...", highlight: ... }.'
      );
  ...
  Na.prototype.search = function (a, c, b, e) {
    ...
    if (b) {
      ...
      r = b.resolve !== !1;
      m = b.cache;
      this.store && b.highlight && !r
        ? console.warn(
            'Highlighting results can only be done on a final resolver task or when calling .resolve({ highlight: ... })'
          )
        : this.store &&
          b.enrich &&
          !r &&
          console.warn(
            'Enrich results can only be done on a final resolver task or when calling .resolve({ enrich: true })'
          );
          ...
          if (v.length) {
            for (n = 0; n < v.length; n += 2) {
              if (this.db) {
                ...
                if (!e) {
                  console.warn(
                    "Tag '" + v[n] + ':' + v[n + 1] + "' will be skipped because there is no field '" + v[n] + "'."
                  );
                  continue;
                }
      ...
      if (!r && !g) {
        ...
        if (!g) {
          throw Error(
            "Apply resolver on document search requires either the option 'pluck' to be set or just select a single field name in your query."
          );
        }
      }
    ...
    for (let B = 0, z, C, J; B < p.length; B++) {
      ...
      N(C) ||
        ...
        (x = aa(G.offset, x)),
        (h = aa(G.suggest, h)),
        (t = r && this.store && aa(G.highlight, t)),
        (q = !!t || (r && this.store && aa(G.enrich, q))),
        (m = aa(G.cache, m)));
      if (e) {
        z = e[B];
      } else {
        ...
        n &&
          (this.db && ((A.tag = n), (A.field = p), (F = E.db.support_tag_search)),
          !F && D && (A.enrich = !1),
        ...
        if (this.db && e) {
          ...
          for (let L = 0, O, P; L < n.length; L += 2) {
            ...
            if (!O) {
              if (
                (console.warn(
                  "Tag '" + n[L] + ':' + n[L + 1] + "' will be skipped because there is no field '" + n[L] + "'."
                ),
                h)
              ) {
                continue;
      ...
      if (this.db && n && n.length && !F) {
        for (q = 0; q < n.length; q += 2) {
          ...
          if (!f) {
            if (
              (console.warn(
                "Tag '" + n[q] + ':' + n[q + 1] + "' was not found because there is no field '" + n[q] + "'."
              ),
              h)
            ) {
              continue;
    ...
    for (x = 0; x < f.length; x++) {
      ...
      q &&
        n.length &&
        typeof n[0].doc === 'undefined' &&
        (this.db ? v.push((n = this.index.get(this.field[0]).db.enrich(n))) : (n = Ta.call(this, n)));
      if (g) {
  ...
  function fb(a) {
    ...
    for (let d = 0, f, g, k, h, l, m, p; d < a.length; d++) {
      ...
      for (let u = 0; u < k.length; u++) {
        if (
          ((l = k[u]),
          typeof l !== 'object' ? (l = { id: (h = l) }) : (h = l.id),
          (m = b[h]) ? m.push(g) : ((l.field = b[h] = [g]), c.push(l)),
          (p = l.highlight))
        ) {
    ...
    if ((b = c.tag)) {
      if ((typeof b === 'string' && (b = [b]), b.length)) {
        ...
        for (let d = 0, f, g; d < b.length; d++) {
          ...
          f.custom
            ? (this.A[d] = f.custom)
            : ((this.A[d] = hb(g, this.D)),
              f.filter &&
                (typeof this.A[d] === 'string' && (this.A[d] = new String(this.A[d])), (this.A[d].G = f.filter)));
          this.F[d] = g;
  ...
  w.mount = function (a) {
    if (this.worker) {
      throw Error(
        "You can't use Worker-Indexes on a persistent model. That would be useless, since each of the persistent model acts like Worker-Index by default (Master/Slave)."
      );
    }
    let c = this.field;
    if (this.tag) {
  ...
  function ib(a, c) {
    ...
    for (let f = 0, g, k; f < e.length; f++) {
      ...
      k.custom
        ? (this.B[f] = k.custom)
        : ((this.B[f] = hb(g, this.D)),
          k.filter && (typeof this.B[f] === 'string' && (this.B[f] = new String(this.B[f])), (this.B[f].G = k.filter)));
      this.field[f] = g;
    }
    if (this.h) {
      a = c.store;
      ...
      for (let f = 0, g, k; f < a.length; f++) {
        (g = a[f]),
          (k = g.field || g),
          g.custom
            ? ((this.h[f] = g.custom), (g.custom.O = k))
            : ((this.h[f] = hb(k, this.D)),
              g.filter &&
                (typeof this.h[f] === 'string' && (this.h[f] = new String(this.h[f])), (this.h[f].G = g.filter)));
      }
    }
    return b;
  }
    ...
    if (c && (a || a === 0)) {
      ...
      if (l) {
        ...
        for (let r = 0; r < l; r++) {
          ...
          var d = t.length;
          if (d && (e || !p[t])) {
            var f = this.score ? this.score(c, t, r, null, 0) : wb(u, l, r),
              g = '';
              ...
              default:
                if ((Y(this, p, t, f, a, b), e && l > 1 && r < l - 1)) {
                  for (d = this.N, g = t, f = Math.min(e + 1, this.rtl ? r + 1 : l - r), k = 1; k < f; k++) {
                    ...
                    const n = this.score
                      ? this.score(c, g, r, t, k - 1)
                      : wb(d + (l / 2 > d ? 0 : 1), l, r, f - 1, k - 1);
    ...
    if (!(k = c[b]) || (g && !k[g])) {
      g
        ? ((c = k || (c[b] = I())),
          (c[g] = 1),
          (h = a.ctx),
          (k = h.get(g)) ? (h = k) : h.set(g, (h = a.keystore ? new Q(a.keystore) : new Map())))
        : ((h = a.map), (c[b] = 1));
  ...
  function T(a, c) {
    ...
    b = a.context;
    const e = b === !0 ? { depth: 1 } : b || {},
      d = N(a.encoder) ? wa[a.encoder] : a.encode || a.encoder || {};
  ...
  function ub(a) {
    a.commit_timer ||
      (a.commit_timer = setTimeout(function () {
        a.commit_timer = null;
        a.db.commit(a);
      }, 1));
  }
    ...
    c.onupgradeneeded = function () {
      ...
      for (let e = 0, d; e < Cb.length; e++) {
        ...
        for (let f = 0, g; f < Db[a.id].length; f++) {
          (g = Db[a.id][f]),
            b.objectStoreNames.contains(d + (d !== 'reg' ? (g ? ':' + g : '') : '')) ||
              b.createObjectStore(d + (d !== 'reg' ? (g ? ':' + g : '') : ''));
        }
      }
    };
  ...
  w.commit = async function (a) {
    ...
    a.reg.size &&
      (await this.transaction('map', 'readwrite', function (e) {
      ...
      a.store
        ? await this.transaction('reg', 'readwrite', function (e) {
      ...
      a.tag &&
        (await this.transaction('tag', 'readwrite', function (e) {
  ...
  const Gb = { Index: T, Charset: wa, Encoder: ka, Document: Na, Worker: La, Resolver: X, IndexedDB: Eb, Language: {} },
    Hb = typeof self !== 'undefined' ? self : typeof global !== 'undefined' ? global : self;
  let Ib;
  (Ib = Hb.define) && Ib.amd
    ? Ib([], function () {
        return Gb;
      })
    : typeof Hb.exports === 'object'
      ? (Hb.exports = Gb)
      : (Hb.FlexSearch = Gb);
})(this || self);
